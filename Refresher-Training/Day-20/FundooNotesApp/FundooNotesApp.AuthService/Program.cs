...
using FundooNotesApp.AuthService.Repositories;
using FundooNotesApp.AuthService.Services;
...
builder.Services.AddSingleton(new RedisCacheHelper(redisConnectionString));
...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "Fundoo Auth Service API", Version = "v1" });
...
{
    // Database transient fallback handler
}
