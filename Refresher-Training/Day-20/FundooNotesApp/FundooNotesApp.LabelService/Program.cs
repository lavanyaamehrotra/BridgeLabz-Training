...
using FundooNotesApp.LabelService.Repositories;
using FundooNotesApp.LabelService.Services;
...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "Fundoo Label Service API", Version = "v1" });
...
try
{
    ...
    {
        var context = scope.ServiceProvider.GetRequiredService<LabelDbContext>();
