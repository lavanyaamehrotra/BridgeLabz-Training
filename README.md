...
* Learned to store book details (title, author, status) using arrays.
* Implemented partial title search using string operations.
* Created methods for:
* Searching books
...
* Practiced case-insensitive string comparison using .EqualsIgnoreCase() for matching answers.
* Printed detailed feedback for each question: Correct / Incorrect.
* Calculated total percentage score and displayed pass/fail message.
...
# Day 18: January 6, 2026- Inheritance, Interfaces & Arrays 📅                                       
...
# Day 19: January 7, 2026- Data Structures Introduction 📅                         
...
# Day 20: January 8, 2026- Collections & Polymorphic Systems 📅                                        
